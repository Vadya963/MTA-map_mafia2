...
--menu from mafia 2
local menu_m2 = guiCreateStaticImage( screenWidth/2-30, screenHeight-100, 57, 58, ":radar_and_map_mafia2/hud/window-m2.png", false )
local sx,sy = guiGetSize(menu_m2, false)
local px,py = guiGetPosition(menu_m2, false)
local arrow_m2 = {
	[1] = {guiCreateStaticImage( (sx/2)-(13/2), sy-16, 13, 8, ":radar_and_map_mafia2/hud/window-arrow-off-down.png", false, menu_m2 ), guiCreateLabel( px+(sx/2)-(25/2), py+sy+3, 25, 15, "test", false ), "down", guiCreateLabel( px+(sx/2)-(25/2)+1, py+sy+3+1, 25, 15, "test", false )},
	[2] = {guiCreateStaticImage( 8, (sy/2)-(13/2), 8, 13, ":radar_and_map_mafia2/hud/window-arrow-off-left.png", false, menu_m2 ), guiCreateLabel( px-25-5, py+(sy/2)-(15/2), 25, 15, "test", false ), "left", guiCreateLabel( px-25-5+1, py+(sy/2)-(15/2)+1, 25, 15, "test", false )},
	[3] = {guiCreateStaticImage( (sx/2)-(13/2), 8, 13, 8, ":radar_and_map_mafia2/hud/window-arrow-off-up.png", false, menu_m2 ), guiCreateLabel( px+(sx/2)-(25/2), py-15-5, 25, 15, "test", false ), "up", guiCreateLabel( px+(sx/2)-(25/2)+1, py-15-5+1, 25, 15, "test", false )},
	[4] = {guiCreateStaticImage( sx-16, (sy/2)-(13/2), 8, 13, ":radar_and_map_mafia2/hud/window-arrow-off-right.png", false, menu_m2 ), guiCreateLabel( px+sx+5, py+(sy/2)-(15/2), 25, 15, "test", false ), "right", guiCreateLabel( px+sx+5+1, py+(sy/2)-(15/2)+1, 25, 15, "test", false )},
}
...
for i=1,4 do
	function select_button_menu ( absoluteX, absoluteY, hud )--наведение на меню
		...
		guiStaticImageLoadImage(arrow_m2[i][1], ":radar_and_map_mafia2/hud/window-arrow-on-"..arrow_m2[i][3]..".png")
	end
...
for i=1,4 do
	function select_button_menu2 ( absoluteX, absoluteY, hud )--покидание меню
		...
		guiStaticImageLoadImage(arrow_m2[i][1], ":radar_and_map_mafia2/hud/window-arrow-off-"..arrow_m2[i][3]..".png")
	end
